            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse" style="float:right;">
                    <ul class="nav navbar-nav">
                        <li class="dropdown">
                            <a href="${ctx}/static/#" class="dropdown-toggle" data-toggle="dropdown"><i
                                    class="glyphicon glyphicon-user"></i> 张三<span class="caret"></span></a>
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="${ctx}/static/member.html"><i class="glyphicon glyphicon-scale"></i>
                                    会员中心</a></li>
                                <li><a href="${ctx}/static/#"><i class="glyphicon glyphicon-comment"></i> 消息</a></li>
                                <li class="divider"></li>
                                <li><a href="${ctx}/static/index.html"><i class="glyphicon glyphicon-off"></i> 退出系统</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
...
<div class="container" style="margin-top:20px;">
    <div class="row clearfix">
        <div class="col-md-12 column">
            <div id="footer">
                <div class="footerNav">
                    <a rel="nofollow" href="${ctx}/static/http://www.atguigu.com">关于我们</a> | <a rel="nofollow"
                                                                                                href="${ctx}/static/http://www.atguigu.com">服务条款</a>
                    | <a rel="nofollow" href="${ctx}/static/http://www.atguigu.com">免责声明</a> | <a rel="nofollow"
                                                                                                  href="${ctx}/static/http://www.atguigu.com">网站地图</a>
                    | <a rel="nofollow" href="${ctx}/static/http://www.atguigu.com">联系我们</a>
                </div>
                <div class="copyRight">
