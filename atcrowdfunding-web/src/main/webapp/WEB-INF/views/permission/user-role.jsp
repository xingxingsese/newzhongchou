                ...
                <div class="panel-body">
                    <form role="form" class="form-inline">
                        <div class="form-group">
                            ...
                            <select id="unAssignSelect" class="form-control" multiple size="10"
                        ...
                        <div class="form-group">
                            <ul>
                                ...
                                <br>
                                <li id="removeRoleBtn" class="btn btn-default glyphicon glyphicon-chevron-left"
                                    style="margin-top:20px;"></li>
                            </ul>
                        </div>
                        <div class="form-group" style="margin-left:40px;">
                            <label for="exampleInputPassword1">已分配角色列表</label><br>
                            <select id="assignSelect" class="form-control" multiple size="10"
                                    style="width:200px;overflow-y:auto;">
