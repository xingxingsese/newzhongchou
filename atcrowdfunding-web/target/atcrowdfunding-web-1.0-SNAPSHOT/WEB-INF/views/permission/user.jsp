                            ...
                            <tr>
                                <td colspan="6" align="center">
                                    <ul class="pagination">
                                        ...
                                        <!-- 有上一页再显示 -->
                                        <li><a href="${ctx}/admin/index.html?pn=1&condition=${sessionScope.condition}">首页</a>
                                        </li>
                                        <c:if test="${page.hasPreviousPage }">
                                            <li><a
                                                    href="${ctx}/admin/index.html?pn=${page.prePage }&condition=${sessionScope.condition}">上一页</a>
                                            </li>
                                        </c:if>
                                        ...
                                        <c:forEach items="${page.navigatepageNums }" var="num">
                                            ...
                                            <c:if test="${num !=page.pageNum }">
                                                <li><a
                                                        href="${ctx}/admin/index.html?pn=${num }&condition=${sessionScope.condition}">${num }</a>
                                                </li>
                                            </c:if>
                                        </c:forEach>
                                        ...
                                        <c:if test="${page.hasNextPage }">
                                            <li><a
                                                    href="${ctx}/admin/index.html?pn=${page.nextPage }&condition=${sessionScope.condition}">下一页</a>
                                            </li>
                                        </c:if>

                                        <li><a
                                                href="${ctx}/admin/index.html?pn=${page.pages }&condition=${sessionScope.condition}">末页</a>
                                        </li>
                                    </ul>
                                </td>
                            </tr>
